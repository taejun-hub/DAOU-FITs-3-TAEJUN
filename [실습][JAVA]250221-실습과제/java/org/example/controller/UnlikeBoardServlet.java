...
@WebServlet("/unlikeBoard")
public class UnlikeBoardServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int success = this.likeServletService.unlikeBoard(new LikeVO(memberId, Integer.parseInt(board_id)));
        if (success > 0) {
            jsonResponse.put("status", "success");
            jsonResponse.put("message", "좋아요 해제");
        } else {
